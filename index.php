...
<!-- Top nav -->
				<div class="col-xl-10 col-md-8 col-lg-9 ml-auto py-2 fixed-top top-nav mb-sm-3">
					<div class="row align-items-center">
						<div class="col-md-4">
							<h4 class="text-white mb-0 text-uppercase">Department Master</h4>
						</div>
						<div class="col-md-5">
							<form>
						...
						<div class="col-md-3 logout-sec mt-sm-2 d-flex justify-content-end">
							...
							<!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#logout-modal">
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-header">
					        <h4 class="modal-title text-uppercase">Add Department</h4>
					      ...
					      <div class="modal-body">
					        <form id="add_form" action="">
					      	<div class="form-group">
							    ...
							    <input type="text" class="form-control" placeholder="Enter Department Name" id="dept_name" required>
							</div>
							</form>
					      </div>
